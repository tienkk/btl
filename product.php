...
?>
  ...
  <div class="jumbotron">
    <h2 class="text-center mt-5">Chọn sản phẩm</h2>
  </div>
       ...
       <div class="row">
            <div class="col-md-3 col-12">
                <div class="list-group">
                 <a href='product.php' class='list-group-item'><i class='fal fa-home ml-2'></i> Sản Phẩm </a>
                <?php  
                   ...
                   $cat_run   = mysqli_query($con,$cat_query);
                    if(mysqli_num_rows($cat_run) > 0){
                      ...
                      echo " <a class='list-group-item'> Không phân loại </a>";
                    }
                ...
                <?php   
                  ...
                  if(mysqli_num_rows($p_run) > 0 ){
                    ...
                    <div class="col-md-4 mt-4">
                        <img src="img/<?php echo $img1; ?>" class="hover-effect" width="100%" height="390px">
                            <div class="text-center mt-3">
                             <h5 title="<?php echo $ptitle; ?>"><?php echo substr($ptitle,0,20); ?>...</h5>
                              <h6>Giá: <?php echo $p_price; ?></h6>
                            </div>
